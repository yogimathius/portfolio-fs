insert into services (title, text_body, call_to_action ,call_to_action_link) values
...
$150 for 2 one-hour sessions.', 'Book', '/contact'),
...
Free / by donation offered on the 3rd Sunday of the month at 10am PST.', 'Sign Up!', 'https://docs.google.com/forms/d/e/1FAIpQLSfu55AdEIvkDzI_Nr0ACDBa6wS1nW3Ri2B9ZtVYWS2H4-ObUg/viewform'),
...
Free / by donation offered on the 4th Sunday of the month at 10am PST.', 'Sign Up!', 'https://docs.google.com/forms/d/e/1FAIpQLSefynS1RyiPkbyAuwdxqnjvTO80--k4T08CGq3dvlMMRS-zLg/viewform'),
('Freebirth Support', 'Are you planning to freebirth your baby?

Are you wanting to know more about autonomous-undisturbed birth and are seeking the presence of an experienced birth keeper to support you?', 'Tell Me More!', '/birth-support'),
('Homebirth Doula', 'Are you planning a homebirth with a licensed midwife and desire the support of an experienced doula who is knowledgeable & passionate about physiological undisturbed birth?', 'Yes!', '/birth-support'),
